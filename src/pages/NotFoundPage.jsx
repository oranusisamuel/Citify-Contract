...
const NotFoundPage = () => {
  return (
    <div className='min-h-screen bg-[radial-gradient(circle_at_top,#d4f1e4,#eaf8f2_45%,#ffffff_85%)] px-6 py-20'>
      <div className='mx-auto flex max-w-3xl flex-col items-center justify-center rounded-3xl border border-brand/15 bg-white/90 px-8 py-14 text-center shadow-[0_20px_60px_rgba(15,23,42,0.08)] backdrop-blur'>
